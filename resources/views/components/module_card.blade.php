...
<section class="
    mt-10 mb-10 ">
    <div class="">
        <div class="grid grid-cols-2 gap-2 bg-gray-300 rounded-md">
            ...
            <img class="col-start-2 md:w-2000 rounded-r-lg" src="/images/pexels-cottonbro-6334771.jpg" alt="Hier sollte ein Profilbild sein.">
        </div>
    </div>
</section>